                                ...
                                {onSelect ? (
                                    ...
                                    <div className="ml-auto md:ml-4">
                                        <Button
                                            variant="ghost"
                                            size="sm"
                                            className="h-7 md:h-9 px-3 md:px-5 text-brand-light hover:text-white hover:bg-brand-accent rounded-xl font-black transition-all group/btn text-[10px] md:text-sm"
                                        >
                                            View Program
                                            <ArrowRight className="ml-1 md:ml-2 size-3 md:size-4 transition-transform group-hover/btn:translate-x-1" />
                                        </Button>
