                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    {colleges.map((hub, i) => (
                        <motion.div
                            ...
                            className={`${hub.span} group flex flex-col xl:flex-row bg-white/30 backdrop-blur-2xl border border-white/60 shadow-white-glow rounded-[3rem] p-3 transition-all duration-500`}
                        >
                            ...
                            {/* Content */}
                            <div className="p-8 w-full xl:w-1/2 flex-1 flex flex-col justify-center">
